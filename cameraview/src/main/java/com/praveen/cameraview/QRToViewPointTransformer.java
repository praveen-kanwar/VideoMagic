...
public class QRToViewPointTransformer
    {
        ...
        public PointF[] transform(ResultPoint[] qrPoints, boolean isMirrorPreview, Orientation orientation, Point viewSize, Point cameraPreviewSize)
            {
        ...
        public PointF transform(ResultPoint qrPoint, boolean isMirrorPreview, Orientation orientation, Point viewSize, Point cameraPreviewSize)
            {
