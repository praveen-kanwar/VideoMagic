        ...
        AutoFocusManager(Camera camera)
            {
                ...
                Utils.showLog(TAG, "Current focus mode '" + currentFocusMode + "'; use auto focus? " + useAutoFocus);
                start();
            }
                ...
                if (!stopped && outstandingTask == null)
                    {
                        ...
                        try
                            ...
                            {
                                Utils.showLog(TAG, "Could not request auto focus : " + ree.toString());
                            }
                    }
            }
                        ...
                        if (!stopped && !focusing)
                            {
                                try
                                    ...
                                    } catch (RuntimeException re)
                                    {
                                        ...
                                        Utils.showLog(TAG, "Unexpected exception while focusing : " + re.toString());
                ...
                if (useAutoFocus)
                    {
                        ...
                        try
                            ...
                            {
                                // Have heard RuntimeException reported in Android 4.0.x+; continue?
                                Utils.showLog(TAG, "Unexpected exception while cancelling focusing : " + re.toString());
                            }
                    }
            }
